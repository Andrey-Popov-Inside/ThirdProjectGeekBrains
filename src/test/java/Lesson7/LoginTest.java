...
@Story("Авторизация позитив/негатив")
public class LoginTest extends AbstractTest {

    @Test
    @DisplayName("Авторизация на сайте")
    @Description("Авторизация на сайте стандартного пользователя")
    ...
    @Description("Авторизация на сайте под несуществующим пользователем")
    @Link("http://google.com")
    @Issue("https://www.saucedemo.com")
    @Severity(SeverityLevel.TRIVIAL)
    @Step("Степ 2")
